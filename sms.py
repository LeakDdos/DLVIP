...
class SPAM:
    ...
    def banner(self):
        ...
        title = '\n\n\n---TOOL SPAM SMS+CALL MOMO Dũng Tí + Nguyễn Minh Quangg---'
        banner = '''\n
             ╦══╩═════════════════════════════════╩══╦
                 ╔═╗╔═╗╔═╗╔╦╗  ╔╦╗╦ ╦╔╗╔╔═╗  ╔╦╗╦
                 ╚═╗╠═╝╠═╣║║║   ║║║ ║║║║║ ╦   ║ ║
      ...
      ╔═════════╩═════════════════════════════════╩═════════╗          
        ...
        - Facebook               : Dũng Tí 
        - Github              : https://github.com/NQD2006
        - Support             :  Dũng Tí - Nguyễn Minh Quangg
        - Box Zalo            :  https://zalo.me/g/qqwpwc294
      ╠═════════╦═════════════════════════════════╦═════════╣
             ╦══╩═════════════════════════════════╩══╦
             ╩══╦═════════════════════════════════╦══╩
      ╔═════════╩═════════════════════════════════╩═════════╗  
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"|Dũng Tí| NHẬP SỐ ĐIỆN THOẠI CẦN SPAM  : "))
            if self.phone != '0337021245':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0337021245':
                print(self.format_print("!", "SỐ ĐIỆN THOẠI ADMIN Dũng Tí  ĐẸP TRAI SPAM CC"))
            time.sleep(3)
